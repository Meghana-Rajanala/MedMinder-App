...
import com.example.myapplication.adapter.DaysAdapter;
import com.example.myapplication.adapter.HorizontalCalendarBaseAdapter;
import com.example.myapplication.adapter.MonthsAdapter;
import com.example.myapplication.models.CalendarItemStyle;
...
import com.example.myapplication.utils.HorizontalCalendarListener;
import com.example.myapplication.utils.HorizontalCalendarPredicate;
import com.example.myapplication.utils.HorizontalSnapHelper;
...
public final class HorizontalCalendar {
    ...
    void init(View rootView, final Calendar defaultSelectedDate, HorizontalCalendarPredicate disablePredicate, CalendarEventsPredicate eventsPredicate) {
        ...
        if (mode == Mode.MONTHS){
            mCalendarAdapter = new MonthsAdapter(HorizontalCalendar.this, startDate, endDate, disablePredicate, eventsPredicate);
        } else {
